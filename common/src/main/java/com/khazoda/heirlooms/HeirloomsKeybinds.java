...
public final class HeirloomsKeybinds {
  ...
  public static final KhazKeybind SHOW_FIRST_NAMING_DETAILS = KhazKeybind.builder(Constants.ID("show_first_naming_details")).defaultKey(InputConstants.KEY_TAB).build();
  ...
  public static void register() {
    KhazClientKeybinds.register(SHOW_ACQUISITION_DETAILS, SHOW_FIRST_NAMING_DETAILS, SHOW_ENCHANTMENT_DETAILS);
  }
}