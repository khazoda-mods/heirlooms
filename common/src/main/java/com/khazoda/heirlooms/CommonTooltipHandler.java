...
public class CommonTooltipHandler {
  ...
  public static void handleTooltip(ItemStack stack, List<Component> tooltip, TooltipFlag flag, boolean isCtrlPressed, boolean isAltPressed) {
    String craftedTimestamp = stack.get(MainRegistry.CRAFTED_TIMESTAMP.get());
    String craftedBy = stack.get(MainRegistry.CRAFTED_BY.get());
    String enchantedTimestamp = stack.get(MainRegistry.ENCHANTED_TIMESTAMP.get());
    String enchantedBy = stack.get(MainRegistry.ENCHANTED_BY.get());
